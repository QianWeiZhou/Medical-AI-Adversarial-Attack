...
FakeImageFolder = '{}/{}NegativeEP{}'.format(checkfolder,st,modelState['genNum'])
...
def test(modelList,data_loader,epoch=0,modelState=None):
    ...
    with torch.no_grad():
        for pX,nX,pT,nT in data_loader:
            ...
            saveImages16(fX.data.cpu().numpy(),pT.data.cpu().numpy())
...
def saveImages16(Xs,IDs,epoch=0):
    for i in range(Xs.shape[0]):
        ...
        imagePath = '{}/{}fakeNeg.png'.format(FakeImageFolder,ID)
