...
DataFolder = './Samples/fakeImages/' 
checkfolder = './Samples/{}FakeDataScores-{}/'.format('test'settypeSTR,AUCepoch)
...
def load_data():
    ...
    testset = ID.ImageDataset(transform=None,setType=0,rootFolder=DataFolder)
...
def saveScores(Scores,title):
    np.savetxt('{}/Scores-{}-fake.txt'.format(checkfolder,title),Scores,fmt='%10.2f',header='%6s,%6s,%6s,%6s'%('id','pos','neg','label'))
